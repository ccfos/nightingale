...
func New(httpConfig httpx.Config, center cconf.Center, alert aconf.Alert, ibex conf.Ibex,
	...
	tc *memsto.TargetCacheType, uc *memsto.UserCacheType, ugc *memsto.UserGroupCacheType, utc *memsto.UserTokenCacheType, notifyChannelCache *memsto.NotifyChannelCacheType) *Router {
	return &Router{
		HTTP:                httpConfig,
		Center:              center,
		Alert:               alert,
