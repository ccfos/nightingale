...
| `request_type=jsm_alert` | `{"api_key": "<JSM API integration key>", "bot_name": "SRE team"}` plus optional `priority_map` (`{"1":"P1","2":"P3"}`) | The key of the JSM team's API integration |
