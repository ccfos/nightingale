...
type AlertRule struct {
	...
	NotifyChannels        StringArray       `json:"notify_channels" gorm:"column:notify_channels;type:varchar(255);comment:通知渠道;"` // split by space: sms voice email dingtalk wecom
