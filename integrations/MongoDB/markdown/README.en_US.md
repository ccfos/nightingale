...
categraf connects to MongoDB as a client and needs sufficient privileges to collect metrics. For details on the required permissions, see the [official documentation](https://www.mongodb.com/docs/manual/reference/built-in-roles/#mongodb-authrole-clusterMonitor). At minimum, the following roles are required:
...
Example of granting the required privileges:
