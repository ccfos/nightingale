...
Forked from [telegraf](https://github.com/influxdata/telegraf/blob/master/plugins/inputs/smart/README.md) with minor changes.
...
## Permissions
Collection requires sudo privileges.
