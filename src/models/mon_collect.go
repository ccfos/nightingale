...
type CollectRule struct {
	Id          int64           `json:"id"`
	Nid         int64           `json:"nid"`
	CollectType string          `json:"collect_type" desc:"just for output"`
	Name        string          `json:"name"`
	Region      string          `json:"region"`
	Comment     string          `json:"comment"`
	Data        json.RawMessage `json:"data"`
	Creator     string          `json:"creator" desc:"just for output"`
	LastUpdator string          `xorm:"last_updator" json:"last_updator" desc:"just for output"`
	Created     time.Time       `xorm:"updated" json:"created" desc:"just for output"`
	LastUpdated time.Time       `xorm:"updated" json:"last_updated" desc:"just for output"`
}
