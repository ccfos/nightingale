...
var TemplateFuncMap = template.FuncMap{
	...
	// n9e TriggerValue is string ,so be it
	...
	"humanize1024": func(s string) string {
		v, err := strconv.ParseFloat(s, 64)
		if err != nil {
			return s
		}
	...
	"humanizeDuration": func(s string) string {
		v, err := strconv.ParseFloat(s, 64)
		if err != nil {
			return s
		}
	...
	"humanizePercentage": func(s string) string {
		v, err := strconv.ParseFloat(s, 64)
		if err != nil {
			return s
		}
	...
	"humanizePercentageH": func(s string) string {
		v, err := strconv.ParseFloat(s, 64)
		if err != nil {
			return s
		}
